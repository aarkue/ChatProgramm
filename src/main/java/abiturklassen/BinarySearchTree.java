 ...
 * </p>
 * <p>
 * Generische Klasse abiturklassen.BinarySearchTree<ContentType>
 * </p>
 * <p>
 * Mithilfe der generischen Klasse abiturklassen.BinarySearchTree koennen beliebig viele
 ...
 * die ebenfalls Objekte der Klasse abiturklassen.BinarySearchTree sind.<br />
 * Die Klasse der Objekte, die in dem Suchbaum verwaltet werden sollen, muss
 * das generische Interface abiturklassen.ComparableContent implementieren. Dabei muss durch
 ...
 * Hinweis: In dieser Version wird die Klasse abiturklassen.BinaryTree nicht benutzt.
 * </p>
 * 
...
public class BinarySearchTree<ContentType extends ComparableContent<ContentType>> {
	 ...
	 * der vorgegebenen Ordnungsrelation in den abiturklassen.BinarySearchTree eingeordnet.
	 * 
	 * @param pContent
	 ...
	 * 
	 * @return den linken Teilbaum (Objekt vom Typ abiturklassen.BinarySearchTree<ContentType>)
	 ...
	 * Wenn er leer ist, wird null zurueckgegeben.
	 * 
	 * @return den rechten Teilbaum (Objekt vom Typ abiturklassen.BinarySearchTree<ContentType>)
