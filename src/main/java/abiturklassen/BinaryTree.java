 ...
 * </p>
 * <p>
 * Generische Klasse abiturklassen.BinaryTree<ContentType>
 * </p>
 * <p>
 * Mithilfe der generischen Klasse abiturklassen.BinaryTree koennen beliebig viele
 ...
 * Objekte der generischen Klasse abiturklassen.BinaryTree sind.
 * </p>
 * 
...
public class BinaryTree<ContentType> {
	 ...
	 *            das Inhaltsobjekt des Wurzelknotens vom Typ ContentType
	 * @param pLeftTree
	 *            der linke Teilbaum vom Typ abiturklassen.BinaryTree<ContentType>
	 * @param pRightTree
	 *            der rechte Teilbaum vom Typ abiturklassen.BinaryTree<ContentType>
	 */
	public BinaryTree(ContentType pContent, BinaryTree<ContentType> pLeftTree, BinaryTree<ContentType> pRightTree) {
		if (pContent != null) {
		  ...
		  // Da der Inhalt null ist, wird ein leerer abiturklassen.BinarySearchTree erzeugt.
			this.node = null;
		}
	}
	 ...
	 * uebergebenen abiturklassen.BinaryTree als linken Teilbaum.
	 * 
	 * @param pTree
	 *            neuer linker Teilbaum vom Typ abiturklassen.BinaryTree<ContentType>
	 */
	 ...
	 * Falls der Parameter null ist, geschieht nichts. Wenn der Binaerbaum leer
	 * ist, wird pTree nicht angehaengt. Andernfalls erhaelt der Binaerbaum den
	 * uebergebenen abiturklassen.BinaryTree als rechten Teilbaum.
	 * 
	 * @param pTree
	 *            neuer linker Teilbaum vom Typ abiturklassen.BinaryTree<ContentType>
	 */
	 ...
	 * Binaerbaum leer ist, wird null zurueckgegeben.
	 * 
	 * @return linker Teilbaum vom Typ abiturklassen.BinaryTree<ContentType> oder null, wenn
	 ...
	 * 
	 * @return rechter Teilbaum vom Typ abiturklassen.BinaryTree<ContentType> oder null, wenn
