 ...
 * </p>
 * <p>
 * Generisches Interface (Schnittstelle) abiturklassen.ComparableContent<ContentType>
 * </p>
 * <p>
 * <p>Das generische Interface abiturklassen.ComparableContent<ContentType> legt die Methoden
 * fest, ueber die Objekte verfuegen muessen, die in einen binaeren Suchbaum
 * (abiturklassen.BinarySearchTree) eingefuegt werden sollen. Die Ordnungsrelation wird in
 * Klassen, die abiturklassen.ComparableContent implementieren durch Ueberschreiben der drei
